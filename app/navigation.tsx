  ...
  return (
    ...
    >
      <div className="flex flex-row w-full items-center justify-around md:flex-col md:h-full md:justify-center md:pt-24 md:gap-8">
        ...
        <Link
          href="/voicing"
          className={`flex flex-col items-center gap-1 hover:scale-110 transition-all ${isActive("/voicing") ? "text-blue-600" : "text-slate-400 hover:text-blue-600"}`}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="w-8 h-8"
          ...
          <span className="text-[11px] font-medium">Voicing</span>
        </Link>
